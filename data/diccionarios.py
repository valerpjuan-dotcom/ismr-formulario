...
_PA_MACROCASOS_JEP = [
    "MACROCASO 01 - TOMA DE REHENES Y OTRAS PRIVACIONES GRAVES DE LA LIBERTAD",
    "MACROCASO 02 - PRIORIZACIÓN DE SITUACIONES DE GRAVE VIOLENCIA SEXUAL",
    "MACROCASO 03 - MUERTES ILEGÍTIMAMENTE PRESENTADAS COMO BAJAS EN COMBATE",
    "MACROCASO 04 - VIOLENCIA HOMICIDA EN ESPECIAL CONTRA MIEMBROS DE LA UNIÓN PATRIÓTICA",
    "MACROCASO 05 - SITUACIÓN TERRITORIAL DE URABÁ",
    "MACROCASO 06 - SITUACIÓN TERRITORIAL DE LA ANTIGUA ZONA DE DISTENSIÓN",
    "MACROCASO 07 - RECLUTAMIENTO Y UTILIZACIÓN DE NIÑAS Y NIÑOS",
    "MACROCASO 08 - SITUACIÓN TERRITORIAL DE CHOCÓ",
    "MACROCASO 09 - SITUACIÓN TERRITORIAL DE NARIÑO",
    "MACROCASO 10 - SITUACIÓN TERRITORIAL DE PUTUMAYO",
    "OTRO MACROCASO / CASO NO PRIORIZADO",
]
...
_PA_INSTANCIAS_PARTIDO = [
    ...
    "COMISIÓN NACIONAL DE CONTROL Y VIGILANCIA",
...
_PA_ROLES_PARTIDO = [
    "Seleccione...",
    "CONSEJERO/A POLÍTICO/A",
    "RESPONSABLE DE FINANZAS",
    "RESPONSABLE DE EDUCACIÓN POLÍTICA",
    "RESPONSABLE DE COMUNICACIONES",
    "RESPONSABLE DE SEGURIDAD",
    "RESPONSABLE DE REINCORPORACIÓN",
    "RESPONSABLE DE GÉNERO Y DIVERSIDAD",
    "RESPONSABLE DE SOLIDARIDAD Y DDHH",
...
_PA_CONSEJERIA_NACIONAL = [
    ...
    "CONSEJERÍA DE ASUNTOS ÉTNICOS",
    "CONSEJERÍA DE ECONOMÍA SOLIDARIA",
    "CONSEJERÍA JURÍDICA",
    "OTRA CONSEJERÍA",
]
